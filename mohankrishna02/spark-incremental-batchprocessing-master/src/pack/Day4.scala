...
object Day4 {
  def main(args: Array[String]): Unit = {
    ...
    val day4 = spark.read.format("csv").option("header", "true").load("D:/BigData/Sparkfolder/workspace/BatchidProcessing/Datasets/data4.csv").withColumn("batchid", lit(1))
    day4.show()
    ...
    val joindf = day4.crossJoin(maxbatchid)
    joindf.show()
