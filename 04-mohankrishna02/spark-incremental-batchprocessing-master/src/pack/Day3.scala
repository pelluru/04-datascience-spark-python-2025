...
object Day3 {
  def main(args:Array[String]):Unit = {
    ...
    val day3 = spark.read.format("csv").option("header","true").load("D:/BigData/Sparkfolder/workspace/BatchidProcessing/Datasets/data3.csv").withColumn("batchid", lit(1))
    day3.show()
    ...
    val joindf = day3.crossJoin(maxbatchid)
    joindf.show()
